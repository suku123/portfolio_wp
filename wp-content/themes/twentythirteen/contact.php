				...
				<div class ="container">
					<div class="row">
						<div class="span12" id="header">
							<a href="http://localhost/portfolio_project/index.html"><img src="<?php bloginfo('template_url');?>/<?php bloginfo('template_url');?>/img/header.gif" width="1200px" alt="Suku Nepali"></a>
						</div>
					</div>
				</div>
				<div class="container">
							...
							<div class="navbar">
								<div class="navbar-inner">
									...
									<ul class="nav navbar-nav">
										<li><img src="<?php bloginfo('template_url');?>/<?php bloginfo('template_url');?>/img/leftnav.gif" alt="suku portfolio"></li>
